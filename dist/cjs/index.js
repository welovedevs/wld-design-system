...
const Typography = (_a) => {
    ...
    return (jsxRuntime.jsx(Component, Object.assign({ className: cn__default["default"](baseStyles$3.container, variant && VariantStyles[variant], classes.container, className), style: Object.assign(Object.assign({}, style), receivedStyle) }, other, { ref: containerRef })));
};
...
const ButtonComponent = React.forwardRef((_a, ref) => {
    var { component: Component = framerMotion.motion.button, className, containerRef, disabled, size = 'regular', color, containerProps, 
...
const RaisedButton = React.forwardRef((props, ref) => {
    ...
    return jsxRuntime.jsx(ButtonComponent, Object.assign({}, props, { ref }, (!disabled && { animate: motionProps })));
});
...
const CheckboxComponent = React.forwardRef((_a, ref) => {
    ...
    return (jsxRuntime.jsxs(Component, Object.assign({ className: cn__default["default"](baseClasses.container, isRadio ? 'ds-rounded-full' : 'ds-rounded-md', disabled && 'ds-cursor-not-allowed ds-bg-dark-50/[0.75]', checked && !disabled && variant === 'raised' && 'ds-bg-current', variant && variantClasses[variant], className), style: {
...
const CheckIcon = ({ checked: propsChecked, partialCheck, classes, }) => {
    ...
    const spring = React.useMemo(() => (checked ? CHECKED_ICON_PROPS : DEFAULT_ICON_PROPS), [checked]);
    return (jsxRuntime.jsx(framerMotion.motion.svg, Object.assign({ className: classes.checkIcon, viewBox: "0 0 24 24", fill: "#fff", animate: spring, transition: { type: 'spring', bounce: 0.6 } }, { children: jsxRuntime.jsxs("g", { children: [propsChecked && jsxRuntime.jsx("path", { d: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" }), !propsChecked && partialCheck && jsxRuntime.jsx("rect", { x: "4", y: "11", width: "17", height: "2" })] }) })));
};
