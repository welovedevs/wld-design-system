...
export declare const wldStyles: {
    wld1: string;
    wld2: string;
    wld3: string;
    wld4: string;
...
export declare const VariantStyles: {
    readonly wld1: string;
    readonly wld2: string;
    readonly wld3: string;
    readonly wld4: string;
    readonly wld5: string;
    readonly wld6: string;
    readonly wld: string;
    readonly tag: string;
