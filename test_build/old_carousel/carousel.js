...
var SwipeIcon = function SwipeIcon(props) {
  return /*#__PURE__*/_react2["default"].createElement("svg", props, /*#__PURE__*/_react2["default"].createElement("title", null, "gesture swipe horizontal 3 (From Streamline App : https://app.streamlineicons.com)"), /*#__PURE__*/_react2["default"].createElement("path", {
...
var ArrowIcon = function ArrowIcon(props) {
  return /*#__PURE__*/_react2["default"].createElement("svg", props, /*#__PURE__*/_react2["default"].createElement("title", null, "8EF129AF-95B1-4C07-9122-3A6270D59E16@2x"), /*#__PURE__*/_react2["default"].createElement("path", {
...
var useStyles = (0, _styles.makeStyles)(_carousel_styles.styles);
...
var NavigateButton = function NavigateButton(_ref) {
  ...
  return /*#__PURE__*/_react2["default"].createElement(_reactSpring.animated.button, {
    onClick: onClick,
  ...
  }, /*#__PURE__*/_react2["default"].createElement(ArrowIcon, null));
};
...
var CarouselStep = function CarouselStep(_ref2) {
  ...
  }, /*#__PURE__*/_react2["default"].createElement(StepContent, {
...
var StepContent = function StepContent(_ref3) {
  ...
  return /*#__PURE__*/_react2["default"].createElement(StructuredStep, {
    onAction: onAction,
    step: step,
    isMobile: isMobile,
    onDismiss: onDismiss,
...
var StructuredStep = function StructuredStep(_ref4) {
  ...
  return /*#__PURE__*/_react2["default"].createElement(_react2["default"].Fragment, null, /*#__PURE__*/_react2["default"].createElement("div", {
  ...
  }, /*#__PURE__*/_react2["default"].createElement(FilestackImage, {
    className: classes.backgroundBlur,
    handle: "PghPn9c7QeuQeZXiyrOM",
    additionalTasks: "resize=width:600,height:340,fit:clip",
    quality: 90
  }), videoLink && /*#__PURE__*/_react2["default"].createElement(ReactPlayer, {
    ...
    width: "100%",
    height: "100%"
  }), imgHandle && /*#__PURE__*/_react2["default"].createElement(_react2["default"].Fragment, null, /*#__PURE__*/_react2["default"].createElement(FilestackImage, {
  ...
  }, title && /*#__PURE__*/_react2["default"].createElement(_typography.Typography, {
    ...
    component: function component(_ref5) {
      ...
      return /*#__PURE__*/_react2["default"].createElement("span", _extends({
        dangerouslySetInnerHTML: {
          __html: typeof title === 'string' ? title : formatHTMLMessage(title)
        }
      }, other));
    }
  }), subtitle && /*#__PURE__*/_react2["default"].createElement(_typography.Typography, {
    className: classes.title,
  ...
  }, dismissable && /*#__PURE__*/_react2["default"].createElement(_button.Button, {
    onClick: onDismiss,
    variant: "contained",
    style: {
      color: 'white'
    }
  }, /*#__PURE__*/_react2["default"].createElement(_reactEmojiRender.Twemoji, {
    svg: true,
    text: formatMessage(dismissButtonText || translations.noThanks)
  })), onClickPayload && /*#__PURE__*/_react2["default"].createElement(_button.Button, {
    variant: "contained",
    size: isMobile && 'small',
    color: "primary",
  ...
  }))))), isMobile && /*#__PURE__*/_react2["default"].createElement(SwipeIcon, {
    ...
    component: function component(_ref7) {
      ...
      return /*#__PURE__*/_react2["default"].createElement(_reactEmojiRender.Twemoji, _extends({
        svg: true,
        text: children
      }, other));
    }
...
var CarouselComponent = function CarouselComponent(_ref8) {
  ...
  return /*#__PURE__*/_react2["default"].createElement(_core.Dialog, _extends({
    classes: {
    ...
    onClose: onClose,
    fullScreen: fullScreen
  }), /*#__PURE__*/_react2["default"].createElement(_reactSlick2["default"], {
    ref: carouselRef,
    dots: true,
    infinite: false,
    prevArrow: /*#__PURE__*/_react2["default"].createElement(NavigateButton, _extends({
      classes: classes
    }, {
      arrowRole: "prev",
      buttonProps: {
    ...
    nextArrow: /*#__PURE__*/_react2["default"].createElement(NavigateButton, _extends({
      classes: classes
    }, {
      arrowRole: "next",
      buttonProps: {
    ...
    return /*#__PURE__*/_react2["default"].createElement(CarouselStep, _extends({
